...
<html lang="en">
  <head>
    ...
    <link href="<?php echo e(url('css/starter-template.css')); ?>" rel="stylesheet" type="text/css">
  </head>
  <body>
    
    <?php if(has('errors')): ?>
    <div class="alert alert-danger p-2 mt-4"><?php echo e(flash('error')); ?></div>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\framework\resources\views/index.blade.php ENDPATH**/ ?>